...
mail.Subject = 'Panalpina House Air Waybill (HAWB) - ' + str(datetime.datetime.today().strftime("%Y-%m-%d"))
mail.Body = 'Test'
mail.HTMLBody = '<p>Dear Team,</p><p>Below overview of uploaded documents for Panalpina</p>'\
