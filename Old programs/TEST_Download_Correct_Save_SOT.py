...
os.chdir(r'\Users\310295192\Desktop\tes\downloaded')
...
for every in filenames:
    ...
    with open(main_path,'r') as k, open(r'C:\\Users\\310295192\\Desktop\\tes\\corrected and sent\\'+magic+'-corrected.xml','w+') as corrected:
...
mail.Body = 'Test'
mail.HTMLBody = '<h2>Podziwiaj</h2>' #this field is optional

os.chdir(r'\Users\310295192\Desktop\tes\corrected and sent')
for dirpath, dirnames, filenames in os.walk(os.getcwd()):
    print("Current Path: ", dirpath)
    print("Directories: ", dirnames)
    print("Files: ", filenames)
...
shutil.rmtree(r'C:\Users\310295192\Desktop\tes\downloaded', ignore_errors=True)
shutil.rmtree(r'C:\Users\310295192\Desktop\tes\corrected and sent', ignore_errors=True)
os.chdir(r'\Users\310295192\Desktop\tes')
